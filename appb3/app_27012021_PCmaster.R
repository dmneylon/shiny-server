...
v6B <- reactive({
  ...
  {
    pcvar <- Configtrans$ConcatenatedQCx3[looper]
  }
  else
  {
    pcvar <- v6A()
    ...
    # Radios #
    ProdInv$Match <- ifelse(str_detect(pcvar, regex(ProdInv$QcodePattern, ignore.case = T)), 1, 0)
    # GSM 900 SM Radios #
    ProdInv$Qty[1]<- ProdInv$Match[1]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[2]<- ProdInv$Match[2]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[3]<- ProdInv$Match[3]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[4]<- ProdInv$Match[4]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[5]<- ProdInv$Match[5]* as.numeric(substr(pcvar,5,5))
    
    # UMTS SM Radios #
    ProdInv$Qty[6]<- ProdInv$Match[6]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[7]<- ProdInv$Match[7]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[8]<- ProdInv$Match[8]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[9]<- ProdInv$Match[9]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[10]<- ProdInv$Match[10]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[11]<- ProdInv$Match[11]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[12]<- ProdInv$Match[12]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[13]<- ProdInv$Match[13]* as.numeric(substr(pcvar,17,17))
    ProdInv$Qty[14]<- ProdInv$Match[14]* as.numeric(substr(pcvar,17,17))
    ProdInv$Qty[15]<- ProdInv$Match[15]* as.numeric(substr(pcvar,17,17))
    ProdInv$Qty[16]<- ProdInv$Match[16]* as.numeric(substr(pcvar,17,17))
    ProdInv$Qty[17]<- ProdInv$Match[17]* as.numeric(substr(pcvar,19,19))
    ProdInv$Qty[18]<- ProdInv$Match[18]* as.numeric(substr(pcvar,19,19))
    
    
    # LTE SM Radios #
    ProdInv$Qty[19]<- ProdInv$Match[19]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[20]<- ProdInv$Match[20]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[21]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[21]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[22]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[22]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[23]<- ProdInv$Match[23]* as.numeric(substr(pcvar,41,41))
    ProdInv$Qty[24]<- ProdInv$Match[24]* as.numeric(substr(pcvar,38,38))
    ProdInv$Qty[25]<- ProdInv$Match[25]* as.numeric(substr(pcvar,38,38))
    ProdInv$Qty[26]<- ProdInv$Match[26]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[27]<- ProdInv$Match[27]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[28]<- ProdInv$Match[28]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[29]<- ifelse(as.numeric(substr(pcvar,44,44) == "X"), 0, ProdInv$Match[29]* as.numeric(substr(pcvar,44,44)))
    ProdInv$Qty[30]<- ifelse(as.numeric(substr(pcvar,44,44) == "X"), 0, ProdInv$Match[30]* as.numeric(substr(pcvar,44,44)))
    ProdInv$Qty[31]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[31]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[32]<- ProdInv$Match[32]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[33]<- ifelse(as.numeric(substr(pcvar,44,44) == "X"), 0, ProdInv$Match[33]* as.numeric(substr(pcvar,44,44)))
    ProdInv$Qty[34]<- ProdInv$Match[34]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[35]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[35]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[36]<- ProdInv$Match[36]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[37]<- ProdInv$Match[37]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[38]<- ProdInv$Match[38]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[39]<- ProdInv$Match[39]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[40]<- ProdInv$Match[40]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[41]<- ProdInv$Match[41]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[42]<- ProdInv$Match[42]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[43]<- ProdInv$Match[43]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[44]<- ProdInv$Match[44]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[45]<- ProdInv$Match[45]* as.numeric(substr(pcvar,29,29))
    ProdInv$Qty[46]<- ProdInv$Match[46]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[47]<- ProdInv$Match[47]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[48]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[48]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[49]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[49]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[50]<- ProdInv$Match[50]* as.numeric(substr(pcvar,38,38))
    ProdInv$Qty[51]<- ProdInv$Match[51]* as.numeric(substr(pcvar,38,38))
    ProdInv$Qty[52]<- ifelse(as.numeric(substr(pcvar,35,35) == "X"), 0, ProdInv$Match[52]* as.numeric(substr(pcvar,35,35)))
    ProdInv$Qty[53]<- ProdInv$Match[53]* as.numeric(substr(pcvar,32,32))
    ProdInv$Qty[54]<- ProdInv$Match[54]* as.numeric(substr(pcvar,32,32))
    
    
    # GSM & UMTS MM Radios
    ProdInv$Qty[55]<- ProdInv$Match[55]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[56]<- ProdInv$Match[56]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[57]<- ProdInv$Match[57]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[58]<- ProdInv$Match[58]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[59]<- ProdInv$Match[59]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[60]<- ProdInv$Match[60]* as.numeric(substr(pcvar,5,5))
    ProdInv$Qty[61]<- ProdInv$Match[61]* as.numeric(substr(pcvar,5,5))
    ...
    # ProdInv$Qty[XX]<- ifelse(substr(pcvar,32,32)== "A", ProdInv$Match[XX]*10, 0)
    # ProdInv$Qty[XX]<- ifelse(substr(pcvar,32,32)== "B", ProdInv$Match[XX]*11,0)
    # ProdInv$Qty[XX]<- ifelse(substr(pcvar,32,32)== "C", ProdInv$Match[XX]*12, 0)
    # ProdInv$Qty[XX]<- ifelse(substr(pcvar,32,32)== "D", ProdInv$Match[XX]*13, 0)
    # ProdInv$Qty[XX]<- ifelse(substr(pcvar,32,32)== "E", ProdInv$Match[XX]*14, 0)
    # ProdInv$Qty[XX]<- ifelse(substr(pcvar,32,32)== "F", ProdInv$Match[XX]*15, 0)
    ...
    # DUG 20
    ProdInv$Qty[100] <- ifelse(substr(pcvar,11,11) == 1, 3, ifelse(substr(pcvar,11,11) == 2, 4, ifelse(substr(pcvar,11,11) == 3, 6, ifelse(substr(pcvar,11,11) == 4, 4,             
                                                                                                                                           ifelse(substr(pcvar,11,11) == 5, 2, ifelse(substr(pcvar,11,11) == 6, 3, ifelse(substr(pcvar,11,11) == 7, 2, ifelse(substr(pcvar,11,11) == 8, 1,                                                                                                                   
                                                                                                                                                                                                                                                              ifelse(substr(pcvar,11,11) == 9, 1, ifelse(substr(pcvar,11,11) == 9, 1,0))))))))))
    
    # DUW 20
    ProdInv$Qty[101] <- ifelse(substr(pcvar,23,23) == 9, 1, 0)
    
    # DUW 30
    ProdInv$Qty[102] <- ifelse(substr(pcvar,23,23) == "K" | substr(pcvar,23,23) == "Q" | substr(pcvar,23,23) == "S" | substr(pcvar,23,23) == 9, 1,
                               ifelse(substr(pcvar,23,23) == "F" | substr(pcvar,23,23) == "L" | substr(pcvar,23,23) == "M" | substr(pcvar,23,23) == "P" | substr(pcvar,23,23) == "T", 2,
                                      ifelse(substr(pcvar,23,23) == "N" | substr(pcvar,23,23) == "4", 3,
                                             ifelse(substr(pcvar,23,23) == 5, 4, 0))))
    
    # DUW 31
    ProdInv$Qty[103] <- ifelse(substr(pcvar,23,23) == "A" | substr(pcvar,23,23) == "F" | substr(pcvar,23,23) == "K" | substr(pcvar,23,23) == "L" 
                               | substr(pcvar,23,23) == "M" | substr(pcvar,23,23) == "Q" | substr(pcvar,23,23) == 4, 1,
                               ifelse(substr(pcvar,23,23) == "B" | substr(pcvar,23,23) == "C", 2,
                                      ifelse(substr(pcvar,23,23) == "D", 3,
                                             ifelse(substr(pcvar,23,23) == "E", 4, 0))))
    
    # DUS 31
    ProdInv$Qty[104] <- ifelse(substr(pcvar,49,49) == 1, 1, ifelse(substr(pcvar,49,49) == 2, 2, ifelse(substr(pcvar,49,49) == 3, 3, ifelse(substr(pcvar,49,49) == 4, 4, 0))))
    
    # # Baseband 5212
    # ProdInv$Qty[105] <- ifelse(substr(pcvar,48,48) == 5, 2, 0)
    
    # # Baseband 5216
    # ProdInv$Qty[106] <- ifelse(substr(pcvar,23,23) == "H", 2, ifelse(substr(pcvar,23,23) == "G" | substr(pcvar,23,23) == "J", 1,
    #                    ifelse(substr(pcvar,48,48) == 3 | substr(pcvar,48,48) == 4 | substr(pcvar,48,48) == 6, 1, 0)))
    
    # Baseband 6620 with fan (BB6620)
    ProdInv$Qty[107] <- sum(ifelse(substr(pcvar,48,48) == 8, 2, ifelse(substr(pcvar,48,48) == "B", 1, 0)),
                            ifelse(substr(pcvar,23,23) == 7, 1,0))
    
    # Baseband 6630 with fan (BB6630)
    ProdInv$Qty[108] <- if(v6A1() == "*")     # that is no 5G
    {
      sum(ifelse(substr(pcvar,11,11) == "A", 1, 0),
          ifelse(substr(pcvar,23,23) == "R" | substr(pcvar,23,23) == 8, 1, 0),
          ifelse(substr(pcvar,48,48) == "B" | substr(pcvar,48,48) == "C" | substr(pcvar,48,48) == "D", 1, 0),
          ifelse(substr(pcvar,48,48) == 7 | substr(pcvar,48,48) == "A", 2, 0),
          ifelse(substr(pcvar,48,48) == "G" | substr(pcvar,48,48) == "H",3,0))
    }
    else
    {
      sum(ifelse(substr(pcvar,11,11) == "A", 1, 0),
          ...
          ifelse(substr(pcvar,48,48) == 7 | substr(pcvar,48,48) == "A", 2, 0),
          ifelse(substr(pcvar,48,48) == "G" | substr(pcvar,48,48) == "H",3,0),
          ifelse(substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == 1 | substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == "A", 1,
                 ifelse(substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) ==2 | substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == "B" | substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == "C", 2, 
                        ifelse(substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == 3 | substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == "D" | substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == "E", 3,
                               ifelse(substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == 4 | substr(pcvar,nchar(pcvar)-1,nchar(pcvar)-1) == "F", 4,
                                      0)))))
    }
    ...
    {
      sum(ifelse(substr(pcvar,23,23) == 8, 1, 0),
          ifelse(substr(pcvar,48,48) == 1 | substr(pcvar,48,48) == "C", 1, 
                 ifelse(substr(pcvar,48,48) == 2 | substr(pcvar,48,48) == "A" | substr(pcvar,48,48) == "G", 2,
                        ifelse(substr(pcvar,48,48) == 9, 4, 0))))
    }
    else
    {
      sum(ifelse(substr(pcvar,23,23) == 8, 1, 0),
          ifelse(substr(pcvar,48,48) == 1 | substr(pcvar,48,48) == "C", 1, 
                 ifelse(substr(pcvar,48,48) == 2 | substr(pcvar,48,48) == "A" | substr(pcvar,48,48) == "G", 2,
                        ifelse(substr(pcvar,48,48) == 9, 4, 0))),
          ifelse(substr(pcvar,nchar(pcvar)-2,nchar(pcvar)-2) == 1, 1, ifelse(substr(pcvar,nchar(pcvar)-2,nchar(pcvar)-2) == 2, 2,
                                                                             ifelse(substr(pcvar,nchar(pcvar)-2,nchar(pcvar)-2) == 3, 3, ifelse(substr(pcvar,nchar(pcvar)-2,nchar(pcvar)-2) == 4, 4, 0)))))
    }
    ...
    ProdInv$Qty[113] <- sum(ifelse(substr(pcvar,23,23) == 6, 1, 0), ifelse(substr(pcvar,48,48) == "E", 1, 0), ifelse(substr(pcvar,nchar(toString(pcvar))-1,nchar(toString(pcvar))-1) == 5, 1, 0))
    
    # Baseband 6502 (BB6502)
    ProdInv$Qty[114] <- ifelse(("Dark" %in% input$Config | substr(pcvar,48,48) == "F" | "6502" %in% input$Config) & substr(pcvar,46,47) == "sm", 1, 0)
    ...
    # Cabinets #
    # RBS6201
    ProdInv$Qty[124] <- ifelse((substr(pcvar,8,9) == "id" | substr(pcvar,20,21) == "id" | substr(pcvar,46,47) == "id") & vSCD() == "B1-B3" & (DS6456[which(DS6456$TelefonicaConfiguration == input$Config),1] %in% cabsx2_B1B3), 2,
                               ifelse((substr(pcvar,8,9) == "id" | substr(pcvar,20,21) == "id" | substr(pcvar,46,47) == "id") & vSCD() == "B2-B3" & (DS6456[which(DS6456$TelefonicaConfiguration == input$Config),1] %in% cabsx2_B2B3), 2,
                                      ifelse((substr(pcvar,8,9) == "id" | substr(pcvar,20,21) == "id" | substr(pcvar,46,47) == "id") & vSCD() == "New Build", 1,
                                             ifelse((substr(pcvar,8,9) == "id" | substr(pcvar,20,21) == "id" | substr(pcvar,46,47) == "id") & vSCD() == "B1-B3" & !(DS6456[which(DS6456$TelefonicaConfiguration == input$Config),1] %in% cabsx2_B1B3), 1,
                                                    ifelse((substr(pcvar,8,9) == "id" | substr(pcvar,20,21) == "id" | substr(pcvar,46,47) == "id") & vSCD() == "B2-B3" & !(DS6456[which(DS6456$TelefonicaConfiguration == input$Config),1] %in% cabsx2_B2B3), 1,
                                                           0)))))
    
    # RBS6102
    ProdInv$Qty[125] <- ifelse((substr(pcvar,8,9) == "oa" | substr(pcvar,20,21) == "oa" | substr(pcvar,20,21) == "oc" | substr(pcvar,20,21) == "of" | substr(pcvar,46,47) == "oa") &
                                 vSCD() == "B1-B3" & (DS6456[which(DS6456$TelefonicaConfiguration == input$Config),1] %in% cabsx2_B1B3), 2,
                               ifelse((substr(pcvar,8,9) == "oa" | substr(pcvar,20,21) == "oa" | substr(pcvar,20,21) == "oc" | substr(pcvar,20,21) == "of" | substr(pcvar,46,47) == "oa") &
    ...
    # York cabinet
    ProdInv$Qty[132] <- ifelse(substr(pcvar,46,47) == "oy" | substr(pcvar,46,47) == "of" | substr(pcvar,46,47) == "ys",1,0)
    
    
    # Lancaster / Shire / 3rd party cabinet
    ProdInv$Qty[134] <- ifelse(substr(pcvar,46,47) == "ys" & HLD() != HLDNB,1,0)
    
    ProdInv$Qty[135] <- ifelse(substr(pcvar,46,47) == "ys" & HLD() == HLDNB,1,0)
    
    
    
    # RBS6202
    ProdInv$Qty[126] <- ifelse(substr(pcvar,8,9) == "sc" | substr(pcvar,20,21) == "oc" | substr(pcvar,20,21) == "sc" | substr(pcvar,46,47) == "sc", 1, 0)
    
    # RBS6147
    ProdInv$Qty[127] <- ifelse(substr(pcvar,20,21) == "io" | substr(pcvar,46,47) == "io", 1, 0)
    
    # RBS6601
    ProdInv$Qty[128] <- ifelse(substr(pcvar,8,9) == "ir" | substr(pcvar,20,21) == "ir" | substr(pcvar,20,21) == "ib" | substr(pcvar,46,47) == "ir" | substr(pcvar,46,47) == "ib", 1, 0)
    
    # 19" Rack
    ProdInv$Qty[129] <- ifelse(substr(pcvar,8,9) == "ir" | substr(pcvar,20,21) == "ir" | substr(pcvar,20,21) == "ib" | substr(pcvar,46,47) == "ir" | substr(pcvar,46,47) == "ib", 1, 0)
    
    # RBS6140/6150
    ProdInv$Qty[130] <- ifelse(substr(pcvar,8,9) == "ob" | substr(pcvar,20,21) == "ob" | substr(pcvar,46,47) == "ob", 1, 0)
    
    # RBS6301
    ProdInv$Qty[131] <- ifelse(substr(pcvar,46,47) == "or", 1, 0)
    
    # Eltek (Indoor/Outdoor)
    ProdInv$Qty[133] <- ifelse(substr(pcvar,8,9) == "ie" | substr(pcvar,20,21) == "ie" | substr(pcvar,46,47) == "ie" |
                                 substr(pcvar,8,9) == "oe" | substr(pcvar,20,21) == "oe" | substr(pcvar,46,47) == "oe", 1, 0)
    
    
    # reserved additional Cab/Enclosure dataframe positions, set to zero until required #
    # # RBS6320
    # ProdInv$Qty[134] <- ifelse(substr(pcvar,8,9) == "od" | substr(pcvar,20,21) == "od" | substr(pcvar,46,47) == "od", 1, 0)
    # 
    # # RBS6501/RBS6502
    # ProdInv$Qty[135] <- ifelse("Dark" %in% input$Config | "6502" %in% input$Config, 0, ifelse(substr(pcvar,20,21) == "sm" | substr(pcvar,46,47) == "sm", 1, 0))
